...
@section('mainarea')
<div class="container">
<h1 class="p-3"  style="font-family: 'Rosalinda Berlinata'">Edit Staff</h1>
<form method="POST" action="/ja_solutions/edit">
    @csrf()
        <div class="row">
            ...
            <div class="col-6"><input type="password" class="form-control" name="staffPass" placeholder="*********"  value="{{$data['staffPass']}}"></div>
